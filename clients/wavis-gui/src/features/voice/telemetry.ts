...
export type TelemetryEvent =
  | {
      ...
      path: WindowsSharePath | 'linux_native' | 'browser_mac';
      reason: string;
      ts: number;
    }
  | {
  ...
  | {
      name: 'codec.session.end';
      smoothnessFreezeMs: number;
      publisherCpuPctMedian: number;
      ts: number;
    };
