...
function ParticipantsPanelImpl({
  ...
  // Record<string, boolean> indexing lies about undefined for a key that was
  // never set — same false-positive as the sub-room/'you' expandedSections
  // lookups elsewhere in this file.
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  const roomsExpanded = expandedSections.rooms ?? true;
        ...
        <>
          {subRooms.map((subRoom) => {
            ...
            const passthroughLabel =
              // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
              activePassthroughInvolvesRoom && passthrough?.label
                ? `“${passthrough.label}”`
                : '“ ”';
