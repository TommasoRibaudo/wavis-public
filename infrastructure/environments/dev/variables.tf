...
variable "ami_id" {
  description = "AMI ID for the EC2 instance. Get from: aws ec2 describe-instances --instance-ids i-0c62cb9c5229b086d --query 'Reservations[0].Instances[0].ImageId' --output text --region us-east-2"
  type        = string
...
variable "subnet_id" {
  description = "Subnet ID where the EC2 instance lives. Get from: aws ec2 describe-instances --instance-ids i-0c62cb9c5229b086d --query 'Reservations[0].Instances[0].SubnetId' --output text --region us-east-2"
  type        = string
...
variable "repo_url" {
  ...
  type        = string
  default     = "https://github.com/Davalf99/wavis.git"
}
...
variable "waf_web_acl_arn" {
  description = "ARN of the WAF WebACL attached to the CloudFront distribution. Get from: aws cloudfront get-distribution --id E20JDZ30DRXUY6 --query 'Distribution.DistributionConfig.WebACLId' --output text"
  type        = string
  default     = ""
}
